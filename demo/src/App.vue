    ...
    <nav class="flex items-center gap-2 px-4 py-2">
        ...
        <div class="flex items-center gap-2">
            <Button v-tooltip="{
                ...
                showDelay: 1000,
                hideDelay: 300,
            }" label="Run" @click="run" :disabled="loading || !settings.targetUUID" icon="pi pi-play" />
            <ProgressSpinner :style="'width: 1.5rem; height: 1.5rem; position: absolute; margin: 0 -2.5rem;' +
